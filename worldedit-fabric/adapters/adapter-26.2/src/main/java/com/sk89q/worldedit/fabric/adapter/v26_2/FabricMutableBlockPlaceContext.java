...
/**
 * Mutable {@link BlockPlaceContext} for FAWE placement-state simulation.
 */
public final class FabricMutableBlockPlaceContext extends BlockPlaceContext {
    ...
    public FabricMutableBlockPlaceContext(ServerLevel level) {
        super(level, null, null, null, DEFAULT_BLOCK_HIT);
        this.level = level;
        this.replaceClicked = false;
    }

    public FabricMutableBlockPlaceContext withSetting(BlockHitResult hitResult, Direction direction) {
